...
public class TicketToPortableShop extends Item{

    {
        image = ItemSpriteSheet.PORTABLE_SHOP;
        stackable = true;
    }
    ...
    public void execute(Hero hero, String action) {
        ...
        if (action.equals(AC_USE)){
            if (Dungeon.branch != Dungeon.BRANCH_PORTABLE){
                depth = Dungeon.depth;
                ...
                InterlevelScene.curTransition = new LevelTransition(Dungeon.level, -1, LevelTransition.Type.BRANCH_EXIT, 28, Dungeon.BRANCH_PORTABLE, LevelTransition.Type.BRANCH_ENTRANCE);
...
//                InterlevelScene.curTransition = new LevelTransition(Dungeon.level, -1, LevelTransition.Type.BRANCH_ENTRANCE, depth, branch, LevelTransition.Type.BRANCH_EXIT);
    ...
    public static class Recipe extends com.shatteredpixel.shatteredpixeldungeon.items.Recipe.SimpleRecipe {
        ...
        {
            inputs =  new Class[]{ Alchemize.class, ScrollOfMidas.class, ScrollOfUpgrade.class };
            inQuantity = new int[]{ 1, 1, 1 };

            cost = 250;

            output = TicketToPortableShop.class;
