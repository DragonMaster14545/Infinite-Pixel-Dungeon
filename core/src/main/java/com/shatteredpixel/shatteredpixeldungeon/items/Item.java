...
//		TREASURED(0x32CD32, "T", chance(61), multi(60)),
		FIERY(0xFFFFFF, "[red][particle+red]Fe[]", chance(100000000000d), multi(72), "[red][particle+red]Fiery"),
		ZENITH(0xFFFFFF, "[rainbow]Ze[]", chance(60000000000d), multi(68), "[rainbow]Zenith"),
		DESOLATED(0xFFFFFF, "[glint+#ad9100]De[]", chance(57500000000d), multi(65), "[glint+#ad9100]Desolated"),
		LIMINAL(0xFFFFFF, "[flicker]Li[]", chance(55000000000d), multi(61), "[flicker]Liminal"),
		RADIANT(0xF0E68C, "R", chance(52500000000d), multi(59), "Radiant"),
		STELLAR(0x87CEFA, "St", chance(50000000000d), multi(58), "Stellar"),
		MAGNIFICENT(0xFFD700, "Mg", chance(47500000000d), multi(57), "Magnificent"),
		EXALTED(0xDAA520, "Ex", chance(45000000000d), multi(56), "Exalted"),
		VALIANT(0xB0C4DE, "V", chance(42500000000d), multi(55), "Valiant"),
		ETHEREAL(0x98FB98, "Et", chance(40000000000d), multi(54), "Ethereal"),
		BRILLIANT(0xFF8C00, "Br", chance(37500000000d), multi(53), "Brilliant"),
		IMPRESSIVE(0xF0E68C, "Im", chance(35000000000d), multi(52), "Impressive"),
		INCREDIBLE(0xFFD700, "In", chance(32500000000d), multi(51), "Incredible"),
		CHERISHED(0xFF1493, "Ch", chance(30000000000d), multi(50), "Cherished"),
		SPLENDID(0x7FFF00, "Sp", chance(27500000000d), multi(49), "Splendid"),
		GLORIOUS(0xFF6347, "G", chance(25000000000d), multi(48), "Glorious"),
		UNFORGETTABLE(0x6A5ACD, "U", chance(22500000000d), multi(47), "Unforgettable"),
		MAGNANIMOUS(0xD2691E, "M", chance(20000000000d), multi(46), "Magnanimous"),
		NOBILITY(0xCD5C5C, "N", chance(17500000000d), multi(45), "Nobility"),
		VISIONARY(0xFFB6C1, "V", chance(15000000000d), multi(44), "Visionary"),
		RESPLENDENT(0xFFD700, "Re", chance(12500000000d), multi(43), "Resplendent"),
		MAGNETIC(0x8B008B, "M", chance(10000000000d), multi(42), "Magnetic"),
		FORTUITOUS(0xFF8C00, "F", chance(7500000000d), multi(41), "Fortuitous"),
		SUPERNATURAL(0x7B68EE, "S", chance(5000000000d), multi(40), "Supernatural"),
		GRANDIOSE(0xFFA07A, "Gr", chance(2500000000d), multi(39), "Grandiose"),
		VALOROUS(0xB22222, "V", chance(1500000000), multi(38), "Valorous"),
		HEROIC(0xB8860B, "H", chance(720000000), multi(37), "Heroic"),
		RESILIENT(0x00FA9A, "R", chance(120000000), multi(36), "Resilient"),
		ILLUSIVE(0x20B2AA, "I", chance(68000000), multi(35), "Illusive"),
		CONQUEROR(0xFF6347, "C", chance(66000000), multi(34), "Conqueror"),
		ROGUE(0xCD853F, "R", chance(69000000), multi(33), "Rogue"),
		SOVEREIGN(0x8A2BE2, "S", chance(62000000), multi(32), "Sovereign"),
		ASCENDED(0xFFE4E1, "A", chance(60000000), multi(31), "Ascended"),
		TRANSLUCENT(0xB0E0E6, "T", chance(58000000), multi(30), "Translucent"),
		MAGNIFIC(0xFF4500, "Mg", chance(56000000), multi(29), "Magnific"),
		UNSTOPPABLE(0xF08080, "U", chance(54000000), multi(28), "Unstoppable"),
		FORTIFIED(0xE6E6FA, "F", chance(52000000), multi(27), "Fortified"),
		HEAVENLY(0xF0E68C, "H", chance(50000000), multi(26), "Heavenly"),
		LUMINOUS(0xB22222, "L", chance(48000000), multi(25), "Luminous"),
		MYSTICAL(0x7FFF00, "My", chance(24000000), multi(24), "Mystical"),
		EXQUISITE(0xFFD700, "Ex", chance(9506600), multi(23), "Exquisite"),
		BLAZING(0xFF4500, "Bl", chance(5420000), multi(22), "Blazing"),
		COSMIC(0x8A2BE2, "C", chance(5000000), multi(21), "Cosmic"),
		TRANQUIL(0x87CEFA, "T", chance(1096000), multi(20), "Tranquil"),
		PRISTINE(0x98FB98, "Pr", chance(512000), multi(19), "Pristine"),
		ULTIMATE(0xF5FFFA, "U", chance(256000), multi(18), "Ultimate"),
		WHIMSICAL(0xFF00FF, "Wh", chance(128000), multi(17), "Whimsical"),
		HARMONIOUS(0x8FBC8F, "H", chance(100000), multi(16), "Harmonious"),
		OMNIPOTENT(0x9932CC, "O", chance(50000), multi(15), "Omnipotent"),
		ETERNAL(0xDC143C, "Et", chance(24800), multi(14), "Eternal"),
		INFINITE(0x4682B4, "In", chance(10960), multi(13), "Infinite"),
		CELESTIAL(0x98FB98, "Ce", chance(5120), multi(12), "Celestial"),
		GALACTIC(0x20B2AA, "G", chance(2560), multi(11), "Galactic"),
		IMMORTAL(0x4B0082, "I", chance(1280), multi(10), "Immortal"),
		TRANSCENDENT(0x8B4513, "T", chance(640), multi(9), "Transcendent"),
		DIVINE(0x87CEEB, "D", chance(320), multi(8), "Divine"),
		ANCIENT(0xFF1493, "A", chance(160), multi(7), "Ancient"),
		MYTHICAL(0x800080, "M", chance(80), multi(6), "Mythical"),
		LEGENDARY(0xFF4500, "L", chance(40), multi(5), "Legendary"),
		EPIC(0xFF00FF, "E", chance(20), multi(4), "Epic"),
		RARE(0x0000FF, "R", chance(10), multi(3), "Rare"),
		UNCOMMON(0xFFFF00, "U", chance(5), multi(2), "Uncommon"),
	...
	public static double chance(double div) {
		return 0.95d / (div + 1);
	}
