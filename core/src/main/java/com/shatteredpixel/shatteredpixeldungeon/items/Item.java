...
//		TREASURED(0x32CD32, "T", chance(61), multi(60)),
		ZENITH(0xFFFFFF, "[rainbow]Ze[]", chance(116), multi(68), "ZENITH"),
		DESOLATED(0xFFFFFF, "[glint+#ad9100]De[]", chance(116), multi(65), "DESOLATED"),
		LIMINAL(0xFFFFFF, "[flicker]Li[]", chance(116), multi(61), "LIMINAL"),
