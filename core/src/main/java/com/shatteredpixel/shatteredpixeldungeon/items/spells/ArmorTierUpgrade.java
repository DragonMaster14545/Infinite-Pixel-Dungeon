...
public class ArmorTierUpgrade extends InventorySpell {
	
	{
		image = ItemSpriteSheet.A_TIER_UPGRADE;
	...
	protected void onItemSelected(Item item) {
        ...
        curUser.damage((long) (curUser.HT * 0.18d), this);
	}
