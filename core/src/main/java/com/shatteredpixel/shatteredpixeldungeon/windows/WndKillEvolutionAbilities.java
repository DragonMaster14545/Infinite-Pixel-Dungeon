...
public class WndKillEvolutionAbilities extends Window {
	...
	public WndKillEvolutionAbilities( KillEvolution killBuff ){
		super();
		...
		for (KillEvolution.KillEvolutionAbility abil : KillEvolution.KillEvolutionAbility.abilities) {
			...
			moveBtn.enable(abil.usable(killBuff));
			add(moveBtn);
    ...
    KillEvolution.KillEvolutionAbility abilityBeingUsed;
